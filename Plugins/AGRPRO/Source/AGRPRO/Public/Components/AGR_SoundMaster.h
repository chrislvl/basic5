...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_FourParams(FCharacterMadeFootstepSound, FHitResult, HitEvent,float, VolumeMulti,UAudioComponent*, Sound, UNiagaraSystem* , Particle);
