...
#include "Data/DA_FootstepConfig.h"

void UDA_FootstepConfig::GetSurfaceReaction(const TEnumAsByte<EPhysicalSurface> InputParam, USoundCue*& Sound, UNiagaraSystem*& Particle)
{
...
void UDA_FootstepConfig::GetVelocityRange(float& MinRange, float& MaxRange)
{
	MinRange = MinVelocity;
	MaxRange = MaxVelocity;
}

void UDA_FootstepConfig::GetFoostepSettings(USoundAttenuation*& AttenuationRef, USoundConcurrency*& ConcurrencyRef)
{
