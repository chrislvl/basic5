...
static struct FScriptStruct_AdvancedSteamSessions_StaticRegisterNativesFBPSteamGroupOfficer
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FBPSteamGroupOfficer()
	{
		...
		if (!ReturnStruct)
		{
			UECodeGen_Private::ConstructUScriptStruct(ReturnStruct, Z_Construct_UScriptStruct_FBPSteamGroupOfficer_Statics::ReturnStructParams);
		}
		return ReturnStruct;
	}
	uint32 Get_Z_Construct_UScriptStruct_FBPSteamGroupOfficer_Hash() { return 1569859454U; }
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_USteamRequestGroupOfficersCallbackProxy_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_USteamRequestGroupOfficersCallbackProxy_GetSteamGroupOfficerList, "GetSteamGroupOfficerList" }, // 796207306
	};
#if WITH_METADATA
	...
	UClass* Z_Construct_UClass_USteamRequestGroupOfficersCallbackProxy()
	{
		...
		if (!OuterClass)
		{
			UECodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_USteamRequestGroupOfficersCallbackProxy_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(USteamRequestGroupOfficersCallbackProxy, 2613864241);
