...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UFindFriendSessionCallbackProxy_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UFindFriendSessionCallbackProxy_FindFriendSession, "FindFriendSession" }, // 29056357
	};
#if WITH_METADATA
	...
	UClass* Z_Construct_UClass_UFindFriendSessionCallbackProxy()
	{
		...
		if (!OuterClass)
		{
			UECodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UFindFriendSessionCallbackProxy_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UFindFriendSessionCallbackProxy, 1199319858);
