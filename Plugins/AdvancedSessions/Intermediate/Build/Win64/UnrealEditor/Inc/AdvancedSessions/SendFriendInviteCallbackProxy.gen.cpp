...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_USendFriendInviteCallbackProxy_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_USendFriendInviteCallbackProxy_SendFriendInvite, "SendFriendInvite" }, // 1158011366
	};
#if WITH_METADATA
	...
	UClass* Z_Construct_UClass_USendFriendInviteCallbackProxy()
	{
		...
		if (!OuterClass)
		{
			UECodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_USendFriendInviteCallbackProxy_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(USendFriendInviteCallbackProxy, 3207833117);
